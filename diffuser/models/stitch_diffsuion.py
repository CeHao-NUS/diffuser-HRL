...
class BatchGaussianDiffusion(nn.Module):
    ...
    @torch.no_grad()
    def conditional_sample(self, cond, batch_size=1, horizon=None, **sample_kwargs):
        '''
...
class BatchValueDiffusion(BatchGaussianDiffusion):
